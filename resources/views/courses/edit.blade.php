    ...
    <div class="container my-5">
        ...
        <form action="{{ route('courses.update', $course->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img width="120" src="{{ asset('uploads/'. $course->image) }}" alt="">
            </div>

            <div class="mb-3">
                <label>Description</label>
                <textarea id="description" name="description" placeholder="Description" class="form-control" rows="5">{{ $course->description }}</textarea>
            </div>

            <button class="btn btn-info btn-lg px-5">Update</button>
